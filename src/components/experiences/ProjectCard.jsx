...
import './ProjectCard.scss';
import {motion} from "framer-motion";
import githubIcon from '/resources/github.png'; // Import de l'icône GitHub

const ProjectCard = ({icon, title, date, description, longDescription, roles, skills, githubLink}) => {
    const [showDetails, setShowDetails] = useState(false);
